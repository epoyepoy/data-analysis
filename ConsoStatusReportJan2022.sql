...
SELECT
	...
	CASE
		WHEN IdleSDate = NULL
		THEN NULL
		ELSE DATEDIFF(month, IdleSDate, '2022-02-25' )
	END AS IdleMonths
FROM
	(
...
--Getting the equipment description
				...
				WHERE
					dbo.tblOpStatus.RD BETWEEN '2021-01-25' AND '2022-01-25' AND
					dbo.tblM6a.rMonth = 1 AND
