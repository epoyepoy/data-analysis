...
SELECT
	...
	CASE
		WHEN IdleSDate = NULL
		THEN NULL
		ELSE DATEDIFF(month, IdleSDate, '2022-05-25' )
	END AS IdleMonths
FROM
	(
--Getting the status for the last 13 months
		SELECT
			...
			TRIM(ISNULL([2022-04-25],'')) AS AprC
		FROM
			(
--Getting the equipment description
				...
				WHERE
					dbo.tblOpStatus.RD BETWEEN '2021-04-25' AND '2022-04-25' AND
					dbo.tblM6a.rMonth = 4 AND
