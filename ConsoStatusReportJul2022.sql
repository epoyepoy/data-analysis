...
SELECT
	...
	CASE
		WHEN IdleSDate = NULL
		THEN NULL
		ELSE DATEDIFF(month, IdleSDate, '2022-08-25' )
	END AS IdleMonths
FROM
	(
--Getting the status for the last 13 months
		SELECT
			...
			TRIM(ISNULL([2022-07-25],'')) AS JulC
		FROM
			(
--Getting the equipment description
				...
				WHERE
					dbo.tblOpStatus.RD BETWEEN '2021-07-25' AND '2022-07-25' AND
					dbo.tblM6a.rMonth = 7 AND
